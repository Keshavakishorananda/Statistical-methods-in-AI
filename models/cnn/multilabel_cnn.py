...
class Multilabel_CNN(nn.Module):
    def __init__(self, Image_height, Image_width, conv_layers, filters, pool_layers, full_layers,activations, dropout, optimizer, epochs, learning_rate):
        super(Multilabel_CNN, self).__init__()
